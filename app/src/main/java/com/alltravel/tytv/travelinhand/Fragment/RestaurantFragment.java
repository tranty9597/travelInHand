...
import com.alltravel.tytv.travelinhand.adapters.AddTravelRestaurantAdapter;
...
import com.alltravel.tytv.travelinhand.services.RestaurantService;
...
public class RestaurantFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        restListView = view.findViewById(R.id.listRest);
        loadRestaurants();
        return view;
    }

    private void loadRestaurants(){
        RestaurantService restaurantService = RetrofitInstance.getRetrofitInstance().create(RestaurantService.class);
        Call<Object> call = restaurantService.getRestaurant("");
        call.enqueue(new Callback<Object>() {
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                if(resJson.get("isError").getAsBoolean()){
                    ...
                    for (JsonElement restau: data) {
                        JsonObject restauObj = (JsonObject) restau;
                        restaurants.add(new Restaurant(
                                restauObj.get("ID").getAsString(),
                                restauObj.get("cityID").getAsString(),
                                restauObj.get("travelLocationID").getAsString(),
                                restauObj.get("phone").getAsString(),
                                restauObj.get("restaurantNm").getAsString()
                        ));
                    }
                    setList();
                }
    ...
    private void setList(){
        AddTravelRestaurantAdapter adapter = new AddTravelRestaurantAdapter(this,(CreateTravelActivity)getActivity(),restaurants);
